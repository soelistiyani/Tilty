...
Documents\Tilty Data\NAMA_STASIUN\
  ...
  minute\2026\2026-09_NAMA_STASIUN.csv
```

CSV berisi `timestamp_utc, station, x_urad, y_urad, temperature_c, status, sample_count`. `sample_count` menunjukkan jumlah sampel valid pembentuk rata-rata satu menit.
